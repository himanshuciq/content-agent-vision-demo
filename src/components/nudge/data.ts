...
export const BATCHES: Batch[] = [
  ...
  },
  {
    ...
    decisions: 2,
    type: "Foundational",
    name: "Backend keywords and attributes",
    chip: "No deadline",
  ...
  },
  {
    ...
    name: "Attributes Amazon requires",
    chip: "No deadline",
    ...
    rationale: "94 SKUs missing the structured attributes Amazon requires for this category.",
    exampleSkuId: "sku-4",
    before: "Country of origin: — · Item form: — · Age range: —",
    after: "Country of origin: United States · Item form: solid · Age range: adult",
    changes: [
      { text: "Filled the attributes Amazon requires for this category", skus: 94 },
...
export const NUDGE_TARGETS: Partial<Record<NudgeKey, NudgeTarget>> = {
  ...
  "team-content": { recipient: "mike", queuePath: "/mike", batchName: "Foundational and retail readiness", value: "$600K", skus: 367 },
